...
# Vectorizer
news_vectorizer = open(r"C:\Users\tsolo\OneDrive\Documents\GitHub\classification-predict-streamlit-template\Vectorizer.pkl", "rb")
tweet_cv = joblib.load(news_vectorizer)  # loading your vectorizer from the pkl file

# Load your raw data
raw = pd.read_csv(r"C:\Users\tsolo\OneDrive\Documents\GitHub\classification-predict-streamlit-template\train.csv")
    ...
    # Building out the "Prediction" page
        ...
        if st.button("Classify"):
            ...
            if selected_model == "Logistic Regression":
                predictor = joblib.load(open(r"C:\Users\tsolo\OneDrive\Documents\GitHub\classification-predict-streamlit-template\Logistic_Regression.pkl", "rb"))
            elif selected_model == "Random Forest":
                predictor = joblib.load(open(r"C:\Users\tsolo\OneDrive\Documents\GitHub\classification-predict-streamlit-template\Decision_Tree_Classifier.pkl", "rb"))
            elif selected_model == "SVM":
                predictor = joblib.load(open(r"C:\Users\tsolo\OneDrive\Documents\GitHub\classification-predict-streamlit-template\Support_Vector.pkl", "rb"))
            else:
